...
3. **El CSS de marca no se toca sin aprobación explícita.** Colores, tipografías (Nunito para títulos/etiquetas/botones, Open Sans para cuerpo de texto — según el manual de identidad de ProSer, sección 8) y la banda multicolor como divisor de secciones son fijos. Cualquier cambio de identidad visual requiere que Harold lo apruebe primero.
