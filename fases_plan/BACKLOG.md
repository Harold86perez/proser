...
- [x] Los colores de marca no eran los oficiales — Harold confirmó los 5 hex exactos por línea de servicio (ver axioma 4 del CLAUDE.md). Se actualizaron las variables de CSS, la banda multicolor, y todos los degradados/valores fijos que quedaban de los colores viejos en `servicios/`, `sobre/`, `proyectos/`, `ebooks/` y `links/`. Recursos/Ebooks pasó de magenta a negro (como Kliné); Membresía ahora combina empresarial+educativo en degradado.
